...
@Component({
  ...
  template: `
    <div class="login">
      ...
      <!-- Icono de la app, despues para cambiar por el real -->
        ...
        <p class="login__subtitle">Ingresa con tu cuenta para continuar</p>

        <form class="login__form" [formGroup]="form" (ngSubmit)="onSubmit()" novalidate>

          <div class="login__field">
            <label class="login__label" for="email">Correo electrónico</label>
            ...
            @if (emailInvalid()) {
              <p id="email-error" class="login__error-text" role="alert">
                @if (form.controls.email.hasError('required')) {
                  Ingresá tu correo electrónico.
                } @else {
                  Ingresá un correo electrónico válido.
                }
              </p>
            }
          </div>
          ...
          <div class="login__field">
            <label class="login__label" for="password">Contraseña</label>
            <div class="login__input-wrapper">
              <svg class="login__input-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                   stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
              ...
              <button
                ...
                [attr.aria-label]="showPassword() ? 'Ocultar contraseña' : 'Mostrar contraseña'"
              >
                @if (showPassword()) {
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
          ...
          <label class="login__checkbox">
            ...
            <span>Mantener sesión iniciada</span>
          </label>
        ...
        <div class="login__divider"><span>o</span></div>
          ...
          <button type="button" class="login__google" (click)="loginWithGoogle()">
            <svg class="login__google-icon" viewBox="0 0 24 24" aria-hidden="true">
              <path fill="#c73e2cff" d="M21.35 11.1H12v2.98h5.35c-.23 1.4-1.62 4.1-5.35 4.1-3.22 0-5.85-2.66-5.85-5.94S8.78 6.3 12 6.3c1.83 0 3.06.78 3.76 1.45l2.56-2.47C16.68 3.7 14.53 2.8 12 2.8 6.98 2.8 2.9 6.88 2.9 11.9S6.98 21 12 21c5.2 0 8.64-3.65 8.64-8.8 0-.59-.06-1.04-.15-1.5z"/>
            </svg>
...
export class LoginComponent implements OnInit , OnDestroy {
  ...
  protected onSubmit(): void {
    ...
    // Spring Security JWT, según lo que se defina) cuando exista el backend.
